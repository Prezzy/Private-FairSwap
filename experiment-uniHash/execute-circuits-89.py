...
def originalCircuit():
    os.system("python ../../aritheval.py --wires wires/wires-89 circuits/uniHash-89.arith inputs/inputs-89 outputs/outputs-89")

def expandedCircuit():
    os.system("python ../../aritheval.py --wires wires/expanded-wires-89 circuits/expanded-uniHash-89.arith inputs/encoded-inputs-89 outputs/encoded-outputs-89")
