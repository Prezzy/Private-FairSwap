...
def originalCircuit():
    os.system("python ../../aritheval.py --wires wires/wires-107 circuits/uniHash-107.arith inputs/inputs-107 outputs/outputs-107")

def expandedCircuit():
    os.system("python ../../aritheval.py --wires wires/expanded-wires-107 circuits/expanded-uniHash-107.arith inputs/encoded-inputs-107 outputs/encoded-outputs-107")
