...
def originalCircuit():
    os.system("python ../../aritheval.py --wires wires/wires-127 circuits/uniHash-127.arith inputs/inputs-127 outputs/outputs-127")

def expandedCircuit():
    os.system("python ../../aritheval.py --wires wires/expanded-wires-127 circuits/expanded-uniHash-127.arith inputs/encoded-inputs-127 outputs/encoded-outputs-127")
